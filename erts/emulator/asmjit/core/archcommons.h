...
//! ARM condition code (both AArch32 & AArch64).
//!
//! \node This enumeration doesn't match condition code that is used in AArch32/AArch64 opcodes. In general this
...
//! ARM data type that can be encoded with the instruction (AArch32 only).
