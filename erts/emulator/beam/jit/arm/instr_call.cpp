...
arm::Mem BeamModuleAssembler::emit_variable_apply(bool includeI) {
    ...
    emit_enter_runtime<Update::eReductions | Update::eStack | Update::eHeap | Update::eXRegs>(3);
    ...
    emit_leave_runtime<Update::eReductions | Update::eStack | Update::eHeap | Update::eXRegs>();
...
arm::Mem BeamModuleAssembler::emit_fixed_apply(const ArgVal &Arity,
    ...
    emit_enter_runtime<Update::eReductions | Update::eStack | Update::eHeap | Update::eXRegs>(
            Arity.getValue() + 2);
